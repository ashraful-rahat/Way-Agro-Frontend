...
const MenuItem: React.FC<MenuItemProps> = ({ setActive, active, item, children }) => {
  return (
          ...
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <div className="hidden lg:flex items-center space-x-8 xl:space-x-12">
              {menuItems.map((menuItem, index) => (
                ...
                >
                  {menuItem.name === "Sujala Food" ? (
                    <MenuItem item={menuItem.name} active={active} setActive={setActive}>
                  ...
                  >
                    ...
                    {menuItem.links.length > 0 && (
                      <div className="space-y-2 pl-4">
                        {menuItem.links.map((link) => (
                          <HoveredLink key={link.name} href={link.href} onClick={() => setIsMobileMenuOpen(false)}>
                            {link.name}
                          </HoveredLink>
                        ))}
                      </div>
